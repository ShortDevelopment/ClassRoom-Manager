...
Public Module ScreenExtension
    ...
    <Extension>
    Public Function GetScreenshot(ByRef screen As Screen, Optional ScalingFactor As Single = 0) As Image
        If Cache.ScreenSize.Width = -1 Then
            Cache.ScreenSize = screen.GetCorrectSize()
        End If
        Dim bounds = New Rectangle(screen.Bounds.Location, Cache.ScreenSize)
        Using bmp As New Bitmap(bounds.Width, bounds.Height)
            ...
            Else
                Return New Bitmap(bmp, New Size(screen.Bounds.Width / ScalingFactor, screen.Bounds.Height / ScalingFactor))
            End If
        End Using
    End Function
...
Public Class Cache
    ...
    Public Shared Property ScreenSize As Size = New Size(-1, -1)
